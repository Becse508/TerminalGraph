...
static inline uint8_t rgb_to_ansi256(uint32_t rgb) {
    ...
    // this is faster and equals to dividing by 256
...
static int (*const emits[])(int, char*, uint32_t) = {
    emit_ansi16, emit_ansi256, emit_truecolor
};
static int const color_sizes[] = {
